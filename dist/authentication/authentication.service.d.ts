...
export declare class AuthenticationService {
    ...
    registerCustomerVerifyOtp(body: any): Promise<{
        message: string;
    }>;
    ...
    resetOtpPassword(body: any): Promise<{
        message: string;
    }>;
    resetEmailPassword(body: any): Promise<{
        message: string;
    }>;
    ...
    saveOtp(phoneNumber: any, otp: any): Promise<void>;
