...
let ReviewSummaryController = class ReviewSummaryController {
    constructor(reviewSummaryService) {
...
], ReviewSummaryController.prototype, "getSummaries", null);
ReviewSummaryController = __decorate([
    (0, common_1.Controller)('review-summary'),
    __metadata("design:paramtypes", [review_summary_service_1.ReviewSummaryService])
