...
let PermissionController = class PermissionController extends base_controller_1.BaseController {
    constructor(permissionService) {
        ...
        this.dtos = { store: create_permission_dto_1.CreatePermissionDto };
        this.permissions = { store: 'permission_management:permission:store' };
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [assign_role_dto_1.AssignPermissionToRoleDto]),
    __metadata("design:returntype", Promise)
], PermissionController.prototype, "assignRoleToUser", null);
