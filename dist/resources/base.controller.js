...
let BaseController = class BaseController {
    ...
    async store(body, user) {
        var _a;
        if (body) {
            const DtoClass = (_a = this.dtos) === null || _a === void 0 ? void 0 : _a.store;
            const validDto = await (0, validator_1.validateDto)(new DtoClass(), body);
    ...
    async update(createData, query, param, user) {
        var _a;
